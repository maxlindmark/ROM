...
```{r plot 3 second y-axis, fig.width=3.14961,fig.heigh=3.14961,echo=FALSE,fig.align='center',warning=FALSE,fig.cap='Gädda in the Great Lakes with secondary y-axis- example of a multiple-series plot using R'}
p3f <- p3 + 
...
```{r plot 4, fig.width = 3.14961, fig.height = 3.14961, echo = FALSE, fig.align='center', fig.cap='Landings of turbot in the Baltic Sea - example of a single-series plot using R'}
p4
```
