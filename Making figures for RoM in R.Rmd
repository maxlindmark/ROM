...
# Introduction
*First, this is a first draft and a work in progress so any feedback on this document or the figures are highly appreciated!*
...
I have chosen data for freshwater pike (*Esox lucious*) to illustrate how you can use this code, because it has all potential data for a RoM species (recreational, multiple areas, error bars etc.). These data have been uploaded on [github](https://github.com/maxlindmark/ROM).
